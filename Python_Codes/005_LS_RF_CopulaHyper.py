...
results_longMSE.to_csv(main_dir+'/Results/Results_paper/RawResultsMSE_005CopHyp.csv')
results_1.to_csv(main_dir+'/Results/Results_paper/TIMERawResultsMSE_005CopHyp.csv')
...
plt.savefig(main_dir+'/Results/Results_paper/ErrorsboxplotMSE_005CopHyp.png')